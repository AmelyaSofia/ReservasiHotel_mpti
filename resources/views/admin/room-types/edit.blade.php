...
<div class="mb-8">
    <div class="flex items-center gap-2 mb-2">
        ...
        <span class="text-xs text-[#B8935A] tracking-widest uppercase">Edit — {{ $roomType->name }}</span>
    </div>
    ...
    <form action="{{ route('admin.room-types.update', $roomType) }}" method="POST" class="space-y-6">
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input type="number" name="price_per_night" id="price_per_night" value="{{ old('price_per_night', (int) $roomType->price_per_night) }}" required min="0" step="1000"
        ...
        <div>
            ...
            <textarea name="description" id="description" rows="4"
                      ...
                      placeholder="Deskripsikan keunggulan dan fasilitas utama tipe kamar ini...">{{ old('description', $roomType->description) }}</textarea>
            @error('description')
                <p class="form-error">{{ $message }}</p>
            @enderror
        </div>
