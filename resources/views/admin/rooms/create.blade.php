...
@section('breadcrumb', 'Tambah unit kamar baru beserta fasilitasnya')
...
<form action="{{ route('admin.rooms.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        {{-- LEFT COLUMN: FORM INPUTS (2/3 width on desktop) --}}
        <div class="lg:col-span-2 space-y-6">
            <div class="card-luxury p-6 sm:p-8 space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    {{-- Status --}}
                    <div>
                        <label for="status" class="form-label">Status Awal Kamar <span class="text-red-700">*</span></label>
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="5" 
                              ...
                              placeholder="Tuliskan deskripsi lengkap kamar di sini..." required>{{ old('description') }}</textarea>
                    @error('description')
                        <p class="form-error">{{ $message }}</p>
                    @enderror
                </div>
        ...
        {{-- RIGHT COLUMN: IMAGE UPLOAD & ACTION BUTTONS (1/3 width on desktop) --}}
        <div class="space-y-6">
            {{-- Panel Foto --}}
            <div class="card-luxury p-6 space-y-5">
                ...
                <div id="imagePreviewContainer" class="relative w-full aspect-video sm:aspect-square lg:aspect-[4/3] bg-[#F7F4EE] border border-[#DDD5C5] overflow-hidden flex flex-col items-center justify-center p-4">
                    ...
                    <div id="imagePlaceholder" class="text-center flex flex-col items-center gap-3">
                        ...
                        <p class="text-[10px] text-[#A89880] px-4">Pilih file gambar berformat JPEG, PNG, JPG, atau Webp (Maks. 2MB)</p>
                    </div>
                </div>
