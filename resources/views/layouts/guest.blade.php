    ...
    <div class="hidden lg:flex lg:w-1/2 relative flex-col items-center justify-center px-16"
        ...
        <div class="relative text-center">
            ...
            <div class="flex items-center justify-center gap-3 mb-10">
                ...
                <p class="text-[#B8935A] text-sm tracking-[0.4em] uppercase font-medium">Luxury Collection</p>
                <div class="w-px h-8 bg-[#B8935A]/60"></div>
            </div>

            <h1 class="text-6xl font-light text-white mb-2" style="font-family: 'Cormorant Garamond', serif; letter-spacing: 0.05em;">
                Royal Crown <span class="italic text-[#D4B896]">Hotel</span>
            </h1>
            <div class="w-16 h-px bg-[#B8935A] mx-auto my-6"></div>
            <p class="text-[#A89880] text-base tracking-widest uppercase font-light">
                Where Elegance Meets Comfort
            </p>

            {{-- Feature list --}}
            <div class="mt-14 space-y-7 text-left">
                @foreach([
                ...
                <div class="flex items-start gap-5">
                    <span class="text-[#B8935A] text-2xl mt-1 shrink-0">{{ $item[0] }}</span>
                    <div>
                        <p class="text-white text-xl font-semibold" style="font-family: 'Cormorant Garamond', serif; letter-spacing: 0.02em;">{{ $item[1] }}</p>
                        <p class="text-[#A89880] text-base mt-1 font-light">{{ $item[2] }}</p>
                    </div>
                </div>
                @endforeach
            </div>
    ...
    <div class="flex-1 flex flex-col items-center justify-center px-6 py-12 lg:px-16"
        ...
        <div class="lg:hidden text-center mb-10">
            <h1 class="text-4xl font-light text-[#2A1D14]" style="font-family: 'Cormorant Garamond', serif; letter-spacing: 0.05em;">
                Royal Crown <span class="italic text-[#B8935A]">Hotel</span>
            </h1>
        ...
        <p class="mt-10 text-[#A89880] text-sm tracking-widest uppercase">
            &copy; {{ date('Y') }} Royal Crown Hotel · All Rights Reserved
        </p>
    </div>
</div>
