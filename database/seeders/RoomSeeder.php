...
class RoomSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $kamarData = [
            // Standar
            ['room_number' => '101', 'room_type_id' => $standar->id,    'capacity' => 2, 'status' => 'available', 'description' => 'Kamar standar lantai 1 dengan pemandangan taman.', 'image' => null],
            ['room_number' => '102', 'room_type_id' => $standar->id,    'capacity' => 2, 'status' => 'available', 'description' => 'Kamar standar lantai 1 dekat kolam renang.', 'image' => null],
            ['room_number' => '103', 'room_type_id' => $standar->id,    'capacity' => 2, 'status' => 'available', 'description' => 'Kamar standar lantai 1 sudut barat.', 'image' => null],
            // Deluxe
            ['room_number' => '201', 'room_type_id' => $deluxe->id,     'capacity' => 2, 'status' => 'available', 'description' => 'Kamar deluxe lantai 2 dengan pemandangan kota.', 'image' => null],
            ['room_number' => '202', 'room_type_id' => $deluxe->id,     'capacity' => 2, 'status' => 'available', 'description' => 'Kamar deluxe lantai 2 dengan balkon.', 'image' => null],
            ['room_number' => '203', 'room_type_id' => $deluxe->id,     'capacity' => 2, 'status' => 'available', 'description' => 'Kamar deluxe lantai 2 king bed.', 'image' => null],
            // Suite
            ['room_number' => '301', 'room_type_id' => $suite->id,      'capacity' => 2, 'status' => 'available', 'description' => 'Suite eksklusif lantai 3 dengan panorama kota malam.', 'image' => null],
            ['room_number' => '302', 'room_type_id' => $suite->id,      'capacity' => 2, 'status' => 'available', 'description' => 'Suite premium lantai 3 dengan jacuzzi.', 'image' => null],
            // Family Room
            ['room_number' => '401', 'room_type_id' => $familyRoom->id, 'capacity' => 4, 'status' => 'available', 'description' => 'Kamar keluarga luas lantai 4 dengan 2 kamar tidur.', 'image' => null],
            ['room_number' => '402', 'room_type_id' => $familyRoom->id, 'capacity' => 4, 'status' => 'available', 'description' => 'Kamar keluarga lantai 4 dekat area bermain.', 'image' => null],
        ];
